...
function load() {
  ...
  if (!r && typeof process !== 'undefined' && 'env' in process) {
    r = Object({"MIX_PUSHER_APP_CLUSTER":"ap1","MIX_PUSHER_APP_KEY":"769157b25f9d01e947e9","NODE_ENV":"development"}).DEBUG;
  }
...
window.io = socket_io_client__WEBPACK_IMPORTED_MODULE_4___default.a;
var EchoInstance = new laravel_echo__WEBPACK_IMPORTED_MODULE_3__["default"]({
  broadcaster: 'socket.io',
  host: window.location.hostname + ':6001'
});
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('example-component', __webpack_require__(/*! ./components/ExampleComponent.vue */ "./resources/js/components/ExampleComponent.vue").default); // axios 请求发送前处理

axios__WEBPACK_IMPORTED_MODULE_1___default.a.interceptors.request.use(function (axiosConfig) {
